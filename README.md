...
* Go to <https://github.com/adobe/aem-site-template-deere/releases/latest> and download `aem-site-template-deere-{version}.zip`
* Upload `aem-site-template-deere-{version}.zip` in AEMaaCS's site creation wizard to create a new site from that template.

## Build locally

Alternatively you can build `aem-site-template-deere-{version}.zip` locally.
...
1. The site template ZIP file is now located below the template root: `aem-site-template-deere-{version}.zip`.
...
* Commit, build and release latest Site Theme related changes in [Site Theme E2E Repo](https://github.com/adobe/aem-site-template-deere-theme-e2e).
